...
export const Logo = memo(({className}: Props) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" className={className}>
            <g fillRule="evenodd">
                <path
                    fillRule="nonzero"
                ...
                />
                <path
                    d="M20.234 27L33 11.344c-.935-.682-1.756-.2-2.208.172l-.016.001-10.644 10.076-4.01-4.392c-1.913-2.011-4.514-.477-5.122-.072L20.234 27"/>
            </g>
        </svg>
    );
});
